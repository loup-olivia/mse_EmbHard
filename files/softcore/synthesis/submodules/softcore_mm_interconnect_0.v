...
`timescale 1 ps / 1 ps
module softcore_mm_interconnect_0 (
		...
		output wire [22:0] SDRAM_controller_s1_address,                                //                                  SDRAM_controller_s1.address
	...
	wire  [101:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> sysid_qsys_0_control_slave_agent:cp_data
	...
	wire  [102:0] cpu_debug_mem_slave_agent_rf_source_data;                                  // CPU_debug_mem_slave_agent:rf_source_data -> CPU_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [102:0] cpu_debug_mem_slave_agent_rsp_fifo_out_data;                               // CPU_debug_mem_slave_agent_rsp_fifo:out_data -> CPU_debug_mem_slave_agent:rf_sink_data
	...
	wire  [101:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> CPU_debug_mem_slave_agent:cp_data
	...
	wire  [102:0] altpll_0_pll_slave_agent_rf_source_data;                                   // altpll_0_pll_slave_agent:rf_source_data -> altpll_0_pll_slave_agent_rsp_fifo:in_data
	...
	wire  [102:0] altpll_0_pll_slave_agent_rsp_fifo_out_data;                                // altpll_0_pll_slave_agent_rsp_fifo:out_data -> altpll_0_pll_slave_agent:rf_sink_data
	...
	wire  [101:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> altpll_0_pll_slave_agent:cp_data
	...
	wire  [102:0] timer_0_s1_agent_rf_source_data;                                           // timer_0_s1_agent:rf_source_data -> timer_0_s1_agent_rsp_fifo:in_data
	...
	wire  [102:0] timer_0_s1_agent_rsp_fifo_out_data;                                        // timer_0_s1_agent_rsp_fifo:out_data -> timer_0_s1_agent:rf_sink_data
	...
	wire  [101:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> timer_0_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                     // timer_0_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [6:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> timer_0_s1_agent:cp_channel
	...
	wire  [101:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> LEDs_s1_agent:cp_data
	...
	wire  [101:0] sysid_qsys_0_control_slave_agent_rp_data;                                  // sysid_qsys_0_control_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [101:0] cpu_debug_mem_slave_agent_rp_data;                                         // CPU_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [101:0] altpll_0_pll_slave_agent_rp_data;                                          // altpll_0_pll_slave_agent:rp_data -> router_005:sink_data
	...
	wire   [83:0] sdram_controller_s1_agent_rp_data;                                         // SDRAM_controller_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [101:0] timer_0_s1_agent_rp_data;                                                  // timer_0_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [101:0] leds_s1_agent_rp_data;                                                     // LEDs_s1_agent:rp_data -> router_008:sink_data
	...
	wire   [83:0] sdram_controller_s1_burst_adapter_source0_data;                            // SDRAM_controller_s1_burst_adapter:source0_data -> SDRAM_controller_s1_agent:cp_data
	...
	wire          router_006_src_valid;                                                      // router_006:src_valid -> SDRAM_controller_s1_rsp_width_adapter:in_valid
	wire   [83:0] router_006_src_data;                                                       // router_006:src_data -> SDRAM_controller_s1_rsp_width_adapter:in_data
	wire          router_006_src_ready;                                                      // SDRAM_controller_s1_rsp_width_adapter:in_ready -> router_006:src_ready
	wire    [6:0] router_006_src_channel;                                                    // router_006:src_channel -> SDRAM_controller_s1_rsp_width_adapter:in_channel
	wire          router_006_src_startofpacket;                                              // router_006:src_startofpacket -> SDRAM_controller_s1_rsp_width_adapter:in_startofpacket
	wire          router_006_src_endofpacket;                                                // router_006:src_endofpacket -> SDRAM_controller_s1_rsp_width_adapter:in_endofpacket
	wire          sdram_controller_s1_rsp_width_adapter_src_valid;                           // SDRAM_controller_s1_rsp_width_adapter:out_valid -> rsp_demux_004:sink_valid
	wire  [101:0] sdram_controller_s1_rsp_width_adapter_src_data;                            // SDRAM_controller_s1_rsp_width_adapter:out_data -> rsp_demux_004:sink_data
	wire          sdram_controller_s1_rsp_width_adapter_src_ready;                           // rsp_demux_004:sink_ready -> SDRAM_controller_s1_rsp_width_adapter:out_ready
	wire    [6:0] sdram_controller_s1_rsp_width_adapter_src_channel;                         // SDRAM_controller_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	wire          sdram_controller_s1_rsp_width_adapter_src_startofpacket;                   // SDRAM_controller_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_004:sink_startofpacket
	wire          sdram_controller_s1_rsp_width_adapter_src_endofpacket;                     // SDRAM_controller_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_004:sink_endofpacket
	wire          cmd_mux_004_src_valid;                                                     // cmd_mux_004:src_valid -> SDRAM_controller_s1_cmd_width_adapter:in_valid
	wire  [101:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> SDRAM_controller_s1_cmd_width_adapter:in_data
	wire          cmd_mux_004_src_ready;                                                     // SDRAM_controller_s1_cmd_width_adapter:in_ready -> cmd_mux_004:src_ready
	wire    [6:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> SDRAM_controller_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_004_src_startofpacket;                                             // cmd_mux_004:src_startofpacket -> SDRAM_controller_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                               // cmd_mux_004:src_endofpacket -> SDRAM_controller_s1_cmd_width_adapter:in_endofpacket
	...
	wire    [6:0] cmd_demux_src3_channel;                                                    // cmd_demux:src3_channel -> crosser:in_channel
	...
	wire    [6:0] crosser_001_out_channel;                                                   // crosser_001:out_channel -> rsp_mux:sink3_channel
	...
	wire          sdram_controller_s1_agent_rdata_fifo_out_valid;                            // SDRAM_controller_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire   [17:0] sdram_controller_s1_agent_rdata_fifo_out_data;                             // SDRAM_controller_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire          sdram_controller_s1_agent_rdata_fifo_out_ready;                            // avalon_st_adapter_004:in_0_ready -> SDRAM_controller_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_004_out_0_valid;                                         // avalon_st_adapter_004:out_0_valid -> SDRAM_controller_s1_agent:rdata_fifo_sink_valid
	wire   [17:0] avalon_st_adapter_004_out_0_data;                                          // avalon_st_adapter_004:out_0_data -> SDRAM_controller_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                         // SDRAM_controller_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                         // avalon_st_adapter_004:out_0_error -> SDRAM_controller_s1_agent:rdata_fifo_sink_error
	...
	softcore_mm_interconnect_0_router router (
	...
	softcore_mm_interconnect_0_router_001 router_001 (
	...
	softcore_mm_interconnect_0_router_002 router_002 (
	...
	softcore_mm_interconnect_0_router_002 router_003 (
	...
	softcore_mm_interconnect_0_router_004 router_004 (
	...
	softcore_mm_interconnect_0_router_002 router_005 (
	...
	softcore_mm_interconnect_0_router_006 router_006 (
	...
	softcore_mm_interconnect_0_router_002 router_007 (
	...
	softcore_mm_interconnect_0_router_002 router_008 (
	...
	softcore_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (altpll_0_c0_clk),                               //        clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset),         //  clk_reset.reset
	...
	softcore_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (altpll_0_c0_clk),                                      //        clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	softcore_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (altpll_0_c0_clk),                       //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	softcore_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (altpll_0_c0_clk),                       //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	softcore_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (altpll_0_c0_clk),                       //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	softcore_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                              //       clk.clk
		.reset               (altpll_0_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	softcore_mm_interconnect_0_cmd_mux_002 cmd_mux_004 (
		.clk                 (altpll_0_c0_clk),                       //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	softcore_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (altpll_0_c0_clk),                       //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	softcore_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (altpll_0_c0_clk),                       //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	softcore_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (altpll_0_c0_clk),                       //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	softcore_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (altpll_0_c0_clk),                       //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	softcore_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (altpll_0_c0_clk),                       //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	softcore_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                              //       clk.clk
		.reset              (altpll_0_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	softcore_mm_interconnect_0_rsp_demux_002 rsp_demux_004 (
		.clk                (altpll_0_c0_clk),                                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset),                   // clk_reset.reset
	...
	softcore_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (altpll_0_c0_clk),                       //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	softcore_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (altpll_0_c0_clk),                       //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	softcore_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (altpll_0_c0_clk),                       //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	softcore_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (altpll_0_c0_clk),                       //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	softcore_mm_interconnect_0_avalon_st_adapter_004 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
